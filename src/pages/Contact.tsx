...
export function Contact() {
  ...
  return <div className="page-wrap">
    <section className="contact-video-hero mx-auto max-w-7xl px-4 pb-28 pt-32 sm:px-6 sm:pt-40">
      {isVideoEnabled && <video className="contact-video-background" autoPlay loop muted playsInline preload="metadata" aria-hidden="true"><source src="/projects/fondo2.mp4" type="video/mp4" /></video>}
